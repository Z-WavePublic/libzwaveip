{{#success build.status}}
  ...
  :new: {{build.message}}
  :debian: `matrixio-libzwaveip_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb`
  :debian: `matrixio-libzwaveip-dev_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb` 
